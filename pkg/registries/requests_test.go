...
func TestGet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			registries, err := Get(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID)
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			registries, err := Create(
				context.Background(),
				&mks.ServiceClient{MKSClient: mksClient},
				clusterID,
...
func TestDelete(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Delete(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, registryID)
...
func TestDeleteAll(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := DeleteAll(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID)
