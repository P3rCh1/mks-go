...
func Get(ctx context.Context, client *mks.ServiceClient, clusterID string) (*mksclient.RegistriesIntegration, error) {
...
func Create(
	ctx context.Context, client *mks.ServiceClient,
...
func Delete(
	ctx context.Context, client *mks.ServiceClient, clusterID, registryID string,
) error {
...
func DeleteAll(
	ctx context.Context, client *mks.ServiceClient, clusterID string,
) error {
