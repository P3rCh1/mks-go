...
func Get(ctx context.Context, client *mks.ServiceClient, clusterID string) (*mksclient.ClusterDetailed, error) {
...
func Create(ctx context.Context, client *mks.ServiceClient, opts *mksclient.ClusterCreateStruct) (*mksclient.ClusterDetailed, error) {
...
func Update(ctx context.Context, client *mks.ServiceClient, clusterID string, opts *mksclient.ClusterUpdateStruct) (*mksclient.ClusterDetailed, error) {
...
func GetKubeconfig(ctx context.Context, client *mks.ServiceClient, clusterID string) ([]byte, error) {
...
func RotateCerts(ctx context.Context, client *mks.ServiceClient, clusterID string) error {
...
func UpgradePatchVersion(ctx context.Context, client *mks.ServiceClient, clusterID string) (*mksclient.ClusterDetailed, error) {
...
func UpgradeMinorVersion(ctx context.Context, client *mks.ServiceClient, clusterID string) (*mksclient.ClusterDetailed, error) {
