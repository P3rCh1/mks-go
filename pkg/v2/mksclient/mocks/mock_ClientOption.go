...
func (_m *MockClientOption) Execute(_a0 *mksclient.Client) error {
	ret := _m.Called(_a0)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*mksclient.Client) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockClientOption_Execute_Call) Run(run func(_a0 *mksclient.Client)) *MockClientOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*mksclient.Client))
	})
	return _c
}
...
func (_c *MockClientOption_Execute_Call) RunAndReturn(run func(*mksclient.Client) error) *MockClientOption_Execute_Call {
	_c.Call.Return(run)
	return _c
}
