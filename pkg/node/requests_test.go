...
func TestGet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			node, err := Get(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID, nodeID)
...
func TestReinstall(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Reinstall(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID, nodeID)
...
func TestDelete(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Delete(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID, nodeID)
