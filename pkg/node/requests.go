...
func Get(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID, nodeID string) (*mksclient.Node, error) {
...
func Reinstall(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID, nodeID string) error {
...
func Delete(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID, nodeID string) error {
