...
func TestListFeatureGates(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			featureGates, err := ListFeatureGates(context.Background(), &mks.ServiceClient{MKSClient: mksClient})
...
func TestListAdmissionControllers(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			admissionControllers, err := ListAdmissionControllers(context.Background(), &mks.ServiceClient{MKSClient: mksClient})
