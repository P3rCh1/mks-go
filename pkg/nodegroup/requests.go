...
func Get(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID string) (*mksclient.NodegroupDetailed, error) {
...
func List(ctx context.Context, client *mks.ServiceClient, clusterID string) ([]mksclient.NodegroupListItem, error) {
...
func Create(ctx context.Context, client *mks.ServiceClient, clusterID string, nodegroups []mksclient.NodegroupCreateStruct) error {
...
func Delete(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID string) error {
...
func Resize(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID string, desired int64) error {
...
func Update(ctx context.Context, client *mks.ServiceClient, clusterID, nodegroupID string, nodegroup mksclient.NodegroupUpdateStruct) error {
