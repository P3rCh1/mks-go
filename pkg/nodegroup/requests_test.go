...
func TestGet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			nodegroup, err := Get(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID)
...
func TestList(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			nodegroups, err := List(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID)
...
func TestCreate(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Create(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nil)
...
func TestDelete(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Delete(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID)
...
func TestResize(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Resize(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID, 0)
...
func TestUpdate(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := Update(context.Background(), &mks.ServiceClient{MKSClient: mksClient}, clusterID, nodegroupID, mksclient.NodegroupUpdateStruct{})
